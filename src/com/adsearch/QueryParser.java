...
public class QueryParser {
    ...
    public List<String> QueryUnderstand(String query) {
        return cleanedTokenize(query);
    }

    private static final Version LUCENE_VERSION = Version.LUCENE_40;
    private static final String STOP_WORDS = "a,able,about,across,after,all,almost,also,am,among,an,and,any,are,as,at,be," +
    ...
    private static List<String> cleanedTokenize(String input) {
        ...
        tokenStream = new StopFilter(LUCENE_VERSION, tokenStream, getStopwords(STOP_WORDS));
